...
export interface EvaluationOrchestratorInput { projectId: string; evaluationId: string; depth: EvaluationDepth; capabilityIds: string[]; allowRemoteModel: true; allowScreenshot: boolean; legacyFallback?: false }

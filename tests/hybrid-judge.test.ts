...
function packet(text = 'Created. Your project is ready.'): EvidencePacket {
  return {
    ...
    actions: [], observations: [{ pageUrl: 'http://127.0.0.1/result', pagePurpose: 'Result', visibleStateSummary: text, primaryAreas: ['Result'], visibleProblems: [], interactableElements: [], formFields: [], evidenceRefs: ['screenshots/final.png'], confidence: 1 }],
    stepVerifications: [{ expectation: '显示 Created', observed: text, status: text.includes('Created') ? 'confirmed' : 'not_confirmed', evidenceRefs: ['screenshots/final.png'], confidence: 1 }], screenshots: ['screenshots/final.png'], tracePath: null, consoleEvidence: [], networkEvidence: [], finalState: { url: 'http://127.0.0.1/result', visibleTextSummary: text },

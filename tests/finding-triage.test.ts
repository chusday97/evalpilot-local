...
function packet(runId: string): EvidencePacket {
  return {
    ...
    stepEvidence: [{ stepIndex: 1, beforeObservationId: 'before', afterObservationId: 'after', beforeScreenshotPath: 'before.png', afterScreenshotPath: 'after.png', decisionId: 'decision-001', verificationId: 'verification-001', actionStatus: 'executed' }],
